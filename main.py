...
class App:
    def __init__(self):
        ...
        self.new_item.create(36, 100, RED)
    ...
    def update(self):
        ...
        if pyxel.btnp(pyxel.KEY_Q):
            # to debug
            print(pyxel.tilemap(0).get(int((self.mplayer.pos.x+1+self.count_background)/8), int((self.mplayer.pos.y)/8)))
